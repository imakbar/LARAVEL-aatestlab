            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-3">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-12">Main Tests</h2>
                                        ...
                                        <span v-for="(item,index) in statusesCount" :key="index">
                                            <span v-if="item.count > 0">
                                                ...
                                                <router-link 
                                                    ...
                                                    :class="item.class"
                                                    :to="Helpers.appEndPoint()+'/tests/'+item.key">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-control-sm" @input.prevent="getItems()" v-model="search.test_short_name">
                                            </td>
                                            <td>
                                    ...
                                    <draggable 
                                        ...
                                        <template #item="{ element }">
                                            <tr>
                                                ...
                                                <td>
                                                    <span v-for="(subTest,subIndex) in element.sub_tests" :key="subIndex">
                                                        <span 
                                                            v-if="Helpers.hasPermission('test_management','can_update')" 
                                                            class="badge cursor-pointer mr-4 mt-2 mb-2"
                                                            v-bind:class="(subTest.status == 'active')?'bg-primary':'bg-secondary'"
                                                        >{{subTest.test_code}} / {{subTest.test_name}}</span>
                                                    </span>
                                                </td>
                                                <td class="statusTd">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                                            <router-link 
                                                                ...
                                                                :to="Helpers.appEndPoint()+'/sub-tests/'+element.id">
                                                                <span>List ({{element.sub_tests.length}})</span>
                                                            </router-link>
...
import MainTestsModal from "@/components/modals/MainTestsModal.vue";

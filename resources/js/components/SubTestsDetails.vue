<template>
    <div class="app-content content">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-3">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-12">Sub Tests Details</h2>
                                        ...
                                        <span v-for="(item,index) in statusesCount" :key="index">
                                            <span v-if="item.count > 0">
                                                ...
                                                <router-link 
                                                    ...
                                                    :class="item.class"
                                                    :to="Helpers.appEndPoint()+'/sub-tests-details/'+mainTestId+'/'+subTestId+'/'+item.key">
                                    ...
                                    <draggable 
                                        ...
                                        <template #item="{ element }">
                                            <tr>
                                                ...
                                                <td>
                                                    <div v-if="element.gender">
                                                        {{ element.gender.title }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div v-if="element.human_lifespan">
                                                        {{ element.human_lifespan.title }}
                                                    </div>
                                                </td>
                                                <td class="statusTd">
        ...
        <Teleport to="body">
            <SubTestsDetailsModal 
                v-if="modalName == 'SubTestsDetailsModal'"
                :recordObj="{
                    recordId:recordId,
                    mainTestId:parseInt(mainTestId),
...
import SubTestsDetailsModal from "@/components/modals/SubTestsDetailsModal.vue";
...
export default defineComponent({
    ...
    setup(){
        ...
        const mainTestId : any = ref(route.params.mainTestId)
        const subTestId : any = ref(route.params.subTestId)

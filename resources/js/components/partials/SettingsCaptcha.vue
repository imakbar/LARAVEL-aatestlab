...
<Transition name="modal">
    <div class="card overflow-hidden" v-if="recordObj.activeTab == 'captcha'">
        <!-- Loading -->
        ...
        <div class="card-body py-2 my-25">
            <div class="mb-10 row">
                ...
                <div class="col-sm-9">
                    <input type="text" id="site_key" class="form-control" v-model="record.site_key" placeholder="Site Key">
                </div>
            </div>
            <div class="mb-10 row">
                <div class="col-sm-3">
                    <label class="col-form-label" for="secret_key">Secret Key</label>
                </div>
                <div class="col-sm-9">
                    <input type="text" id="secret_key" class="form-control" v-model="record.secret_key" placeholder="Secret Key">
                </div>
            </div>
            <div class="row">

            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-3">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-12">Socials</h2>
                            <div class="d-flex align-items-center">
                                <button type="button" class="btn btn-sm btn-primary ml-10 mb-12" @click="addEditModalBtn('add','')" v-if="Helpers.hasPermission('setup_social','can_add')">
                                    Add New
                                </button>
                            </div>
                        </div>
            ...
            <div class="content-body" ref="loadingRefContainer">
                <section class="app-user-list">
                    <div class="card">
                        ...
                        <div v-if="Helpers.hasPermission('setup_social','can_view')">
                                        ...
                                        <span v-for="(item,index) in statusesCount" :key="index">
                                            <span v-if="item.count > 0">
                                                ...
                                                <router-link 
                                                    ...
                                                    :class="item.class"
                                                    :to="Helpers.appEndPoint()+'/setup/socials/'+item.key">
                            ...
                            <div class="table-responsive pt-0 min-h-300">
                                <table class="table table-bordered">
                                    ...
                                    <draggable 
                                        v-if="setupSocials.length > 0"
                                            v-model="setupSocials"
                                            :component-data="{
                                                tag: 'tbody',
                                        ...
                                        <template #item="{ element }">
                                            <tr>
                                                ...
                                                <td class="actionTd" v-if="
                                                    Helpers.hasPermission('setup_social','can_update') ||
                                                    Helpers.hasPermission('setup_social','can_delete')
                                                ">
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                                            ...
                                                            v-if="element.status != 'trash' && Helpers.hasPermission('setup_social','can_update')" class="dropdown-item icon-vertical-center"><vue-feather class="icon" type="file-text" size="16"></vue-feather>Edit</button>
                                                            <button @click="deleteBtn(element.id)" v-if="Helpers.hasPermission('setup_social','can_delete')" href="javascript:;" class="dropdown-item icon-vertical-center delete-record"><vue-feather class="icon" type="trash" size="16"></vue-feather>
    ...
    setup(){
        ...
        const selectAllItems = () => {
            if (allSelected.value) {
                const items :any = setupSocials.value
        ...
        const moveBtn = () => {
            setupSocials.value.map((item, index) => {
                item.order_by = index + 1
            });
            axios.put(Helpers.completeUrl()+pageLevelEndPoint.value+'/order-by', setupSocials.value)
                .then((res) => {
                    errors.value = []
                    sweetalertMessage({
                        status: res.data.status,

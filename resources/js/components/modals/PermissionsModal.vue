<template>
    <Transition name="modal">
        <div
            v-if="recordObj.showModal && recordObj.modalName == 'PermissionsModal'"
                ...
                <div class="modal-content modal-container">
                    ...
                    <div class="modal-body px-sm-2 pb-35 pt-0">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">
                                <span v-if="recordObj.actionMode == 'add'">Add New Permission</span>
                                <span v-if="recordObj.actionMode == 'edit'">Edit Permission</span>
                            </h1>

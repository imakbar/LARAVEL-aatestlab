<template>
    <Transition name="modal">
        <div
            v-if="recordObj.showModal && recordObj.modalName == 'DoctorsModal'"
                ...
                <div class="modal-content modal-container">
                    ...
                    <div class="modal-body px-sm-2 pb-35 pt-0">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">
                                <span v-if="recordObj.actionMode == 'add'">Add Doctor</span>
                                <span v-if="recordObj.actionMode == 'edit'">Edit Doctor</span>
                            </h1>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-10">
                                ...
                                <input type="text" v-model="record.mobile" id="mobile" class="form-control" :class="[errors.mobile != null?'is-invalid':'']" />
                                <div class="invalid-feedback" v-if="errors.mobile != null">{{errors.mobile[0]}}</div>
                            </div>
                            <div class="col-sm-12 mb-10">
                                <label class="form-label" for="clinic">Clinic</label>
                                <input type="text" v-model="record.clinic" id="clinic" class="form-control" :class="[errors.clinic != null?'is-invalid':'']" />
                                <div class="invalid-feedback" v-if="errors.clinic != null">{{errors.clinic[0]}}</div>
                            </div>
                            <div class="col-sm-12 mb-10">
                                <label class="form-label" for="address">Address</label>
                                <input type="text" v-model="record.address" id="address" class="form-control" :class="[errors.address != null?'is-invalid':'']" />
